...
- **Куда складывать** — по умолчанию «Музыка» → `YandexMusic`, папку
  можно выбрать свою. Альбом и плейлист кладутся в папку со своим
...
`HQ+: FLAC`. Видна на любой странице, включая «Мою волну».
