...
Кнопка со стрелкой в панели плеера скачивает то, что играет — и в
обычной панели, и в «Моей волне». В меню трека, альбома, плейлиста и
исполнителя появляется пункт **«Скачать в файл»**, а у исполнителя ещё
и кнопка в шапке рядом с «…».
...
- **Ход дела** — полоска с числом треков и скоростью, а рядом кнопка
  **«Остановить»**: она бросает и то, что качается, и очередь, убирает
  недокачанные куски и говорит, сколько успело сохраниться. Когда всё
  готово, на её месте — **«Открыть папку»**.
- **Сколько качать разом** — по одному, три или пять треков, на выбор
  в настройках.
- **У исполнителя** мод берёт его ходовые треки и складывает в папку с
  именем исполнителя, сказав заранее, сколько их получится.
- **«Скачать офлайн»** — соседний пункт для родного скачивания клиента,
  в память программы. Он появляется там, где сам клиент такого пункта
  не показывает.
- **Очистить скачанное клиентом** — в настройках, в разделе «Память и
  кеш»: видно, сколько занято, и есть кнопка, чтобы убрать. Файлы,
  скачанные модом в свою папку, она не трогает.
...
возвращает исходные размер и место. Размер шрифта меняется ползунком
в самой панели и в настройках.

Текст едет сам: подсвеченная строка плавно встаёт в середину панели.
Пока человек читает — держит мышь над панелью или листает сам — мод
не вмешивается. Ряд кнопок мода в углу на это время уступает место.
Если ни у Яндекса, ни в LRCLib нет текста со временем, мод возьмёт
обычный и честно подпишет: «без времени».
...
и сколько это занимает, и есть кнопка, чтобы это убрать — файлы,
скачанные модом в свою папку, она не трогает.
